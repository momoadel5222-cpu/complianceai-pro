...
Provide 2-3 sentences explaining: why this matched, key compliance risks, and confidence level."""
...
def sanctions_screen():
    ...
    try:
        ...
        # Get query embedding with Gemini
        query_embedding = get_embedding_gemini(name) if use_ai and GEMINI_API_KEY else None
        if query_embedding:
            logger.info("✅ Generated query embedding with Gemini")
